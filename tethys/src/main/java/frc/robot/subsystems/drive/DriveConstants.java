      ...
      case REAL -> {
        MODULE_CONSTANTS = new ModuleConstants[]{
            ...
            ModuleConstants.builder()
                ...
                .steerId(2)
                .encoderId(3)
                .encoderOffset(Rotation2d.fromRotations(-0.122559))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Front Right
            ModuleConstants.builder()
                ...
                .steerId(5)
                .encoderId(6)
                .encoderOffset(Rotation2d.fromRotations(-0.378662))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Back Left
            ModuleConstants.builder()
                ...
                .steerId(8)
                .encoderId(9)
                .encoderOffset(Rotation2d.fromRotations(0.003662))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Back Right
            ModuleConstants.builder()
                ...
                .steerId(11)
                .encoderId(12)
                .encoderOffset(Rotation2d.fromRotations(-0.258301))
                .steerInverted(true)
                .turnInverted(false)
                .build()
        };
